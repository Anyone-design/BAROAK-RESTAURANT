...
export const ReservationSection: React.FC<ReservationSectionProps> = ({
  ...
  return (
    <section id="reservation" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      {/* Title */}
      <div className="text-center max-w-3xl mx-auto space-y-4 mb-14">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-gold-500/10 border border-gold-500/20 text-xs uppercase tracking-widest text-gold-400 font-bold">
          ...
          Real-Time Concierge & Reservations
        </div>
        ...
        <div className="inline-flex p-1.5 rounded-2xl bg-charcoal-900 border border-white/10 mt-6 shadow-xl">
          <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        {/* Left Interactive Form Container (8 Cols) */}
        <div className="lg:col-span-8 p-6 sm:p-10 rounded-3xl bg-charcoal-900/90 border border-gold-500/20 shadow-2xl">
          {activeTab === 'table' ? (
            <div>
              <div className="mb-6">
                ...
                <p className="text-xs sm:text-sm text-slate-400 mt-1">
                  Instant table reservation with preferred seating section selection.
                </p>
              </div>
              <ReservationEngine />
            </div>
            ...
            <div>
              <div className="mb-6">
                ...
                <p className="text-xs sm:text-sm text-slate-400 mt-1">
                  Custom cocktail flights, tandoor small plates, audio setups & bespoke buyouts.
                </p>
              </div>
              <PrivateEventForm />
            </div>
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-charcoal-900/90 border border-white/10 space-y-5">
          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-charcoal-900/90 border border-white/10 space-y-4 text-xs">
            <div className="flex items-center gap-3 text-gold-400">
              <div className="p-2.5 rounded-xl bg-gold-500/10 border border-gold-500/20">
            ...
            <div className="space-y-2.5 text-slate-300 pt-2 border-t border-white/5">
              <div className="flex justify-between">
                <span className="text-slate-400">Daily Dining:</span>
                <span className="font-semibold text-white">{restaurant.hours.timing}</span>
              </div>
              <div className="flex justify-between">
